        ...
        // ------------------------ FORMS INPUT TO BACKEND ---------------------
            ...
            function postData(form) {
                form.addEventListener('submit', (e) => {
                    ...
                    request.setRequestHeader('Content-type', 'application/json'); //Если мы использует XMLHttpRequest + formdata нам заголовок устанавливать НЕНУЖНО он устанавливается автоматически.
